...
public class RestProductController {
  ...
  //상품등록
  @PostMapping
  public RestResponse<Object> add(@RequestBody SaveRest saveRest){
  ...
  //상품조회
  @GetMapping("/{id}")
  public RestResponse<Object> search(@PathVariable("id") Long pid){
    RestResponse<Object> res = null;
...
//      return res;
    ...
    Optional<Product> findedProduct = productSVC.search(pid);
